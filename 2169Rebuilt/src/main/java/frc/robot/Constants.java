...
public final class Constants {
    ...
    public final class Vision{
        ...
        //PhotonVision stuff
        public static final Translation3d FRONT_LEFT_TRANSLATION = new Translation3d(.26035, 0.31115, 0.24765);
        public static final Translation3d BACK_RIGHT_TRANSLATION = new Translation3d(-0.26035, -0.31115, 0.24765);

        public static final Rotation3d FRONT_LEFT_ROTATION = new Rotation3d(0,Units.degreesToRadians(53), Units.degreesToRadians(0)); 
