...
public final class Constants {
    ...
    public final class Vision{
        ...
        //PhotonVision stuff
        public static final Translation3d FRONT_LEFT_TRANSLATION = new Translation3d(0.2595626, -0.12875, 0.2238248);
        public static final Translation3d BACK_RIGHT_TRANSLATION = new Translation3d(-0.2595626, 0.12875, 0.2238248);

        public static final Rotation3d FRONT_LEFT_ROTATION = new Rotation3d(0,Units.degreesToRadians(45), Units.degreesToRadians(45)); 
        public static final Rotation3d BACK_RIGHT_ROTATION = new Rotation3d(0,Units.degreesToRadians(225), Units.degreesToRadians(45));
