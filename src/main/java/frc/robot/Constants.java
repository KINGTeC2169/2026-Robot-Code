...
public final class Constants {
  ...
  public final class Vision{
      ...
      public static final Transform3d FRONT_LEFT_CAMERA_TO_ROBOT = new Transform3d(FRONT_LEFT_TRANSLATION, FRONT_LEFT_ROTATION);
      public static final Transform3d BACK_RIGHT_CAMERA_TO_ROBOT = new Transform3d(BACK_RIGHT_TRANSLATION, BACK_RIGHT_ROTATION);
